...
<html>
 <head>
  ...
  <style>
   ...
   fieldset { width:800px; background-color: #f7f7f7; }
   table { background-color: #dddddd; }
   td, th { text-align: center;padding: 15px; }
   textarea { width: 700px; height: 200px; padding: 12px 20px; box-sizing: border-box;
     border: 2px solid #ccc; border-radius: 4px; resize: none; }
  </style>
  <script>
