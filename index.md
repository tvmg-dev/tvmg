...
Welcome to the documentation for the ThermaV Monitoring Gadget, software to monitor the behaviour of series 3 or 4 versions of the LG R32 ThermaV monobloc heatpump.
...
The heart of this software project is to collect information from an LG R32 Monobloc heat pump in order to provide homeowners greater insight into the operation of their system. Data is collected by reading the LG's Modbus interface using this software running on a suitable microcontroller.
...
[Installation Instructions]({% link docs/install/installation.md %})
