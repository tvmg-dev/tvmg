...
#define TVMG_DEBUG(...)      msgLog( LOGGING_LEVEL::DEBUG, __VA_ARGS__ )
#define TVMG_MSG(...)        msgLog( LOGGING_LEVEL::MSG, __VA_ARGS__ )
#define TVMG_WARN(...)       msgLog( LOGGING_LEVEL::WARNING, __VA_ARGS__ )
#define TVMG_ERROR(...)      msgLog( LOGGING_LEVEL::ERROR, __VA_ARGS__ )
#define TVMG_TIMING(...)     msgLog( LOGGING_LEVEL::TIMING, __VA_ARGS__ )
