...
#define MAX_DAILY_LG_EVENTS   480      // 20 events per hour, 3 minute intervals
...
void  LGHeatPump::updateStatus()
{
   ...
   // so could get more than X events but should be low chance of lots of
   // power cycles and some systemic faiure with the LG.

   if ( m_currentStatus.m_updates == MAX_DAILY_LG_EVENTS )
   {
